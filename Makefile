...
compress:
	jsx jsx js
	uglifyjs js/app_browser.js js/app_infos.js js/app_types.js js/app_intervaller.js js/app_review.js js/app_views.js js/script_app.js  --compress --screw-ie8 --mangle sort -o ginseng.js